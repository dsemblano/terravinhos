...
printf( esc_html__( 'Novo pedido: #%s,', 'woocommerce' ), '<!--[woocommerce/order-number]-->' );
?></h2>
<!-- /wp:heading -->
...
printf( esc_html__( 'Você recebeu um novo pedido de %s', 'woocommerce' ), '<!--[woocommerce/customer-full-name]-->' );
?></p>
<!-- /wp:paragraph -->
